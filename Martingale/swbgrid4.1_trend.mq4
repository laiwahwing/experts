         ...
         for(int o=OrdersTotal()-1; o>=0; o--)
           {
            ...
            if(OrderType()==1)
               ...
               OrderClose(OrderTicket(),OrderLots(),Ask,slipage,CLR_NONE);
           }
        }
      if(signal()==sell)
        {
         for(o=OrdersTotal()-1; o>=0; o--)
           {
            ...
            if(OrderSymbol()!=Symbol() || OrderMagicNumber()!=magic)
               continue;
            if(OrderType()==0)
               OrderClose(OrderTicket(),OrderLots(),Bid,slipage,CLR_NONE);
           }
        }
     }
   if(total()==0 && a==0)
   ...
   if(use_trend)
     {
      ...
      bool fast_up=fast_ma>fast_ma1 && fast_ma1>fast_ma2&&fast_ma2>fast_ma3;
      ...
      if(use_diff)
        {
         ...
         if(fast_down && fast_ma<slow_ma && ma_diff>trend_diff)
           {
            trend=-2;
           }
        }
